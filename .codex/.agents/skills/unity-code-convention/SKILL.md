---
name : unity-code-convention
description: Conventions for writing C# code in this Unity project. Follow existing patterns and project-specific styles when they are more specific than these general guidelines. Use this skill when writing or editing C# code, proposing style improvements, or reviewing code for style consistency.
---
